...
class my_ModelA1(BertPreTrainedModel):
    r"""
        **labels**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size,)``:
            Labels for computing the sequence classification/regression loss.
            Indices should be in ``[0, ..., config.num_labels - 1]``.
    ...
    """
    def __init__(self, config):
        super(my_ModelA1, self).__init__(config)
        self.num_labels = config.num_labels
...
class my_ModelA2(BertPreTrainedModel):
    r"""
        **labels**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size,)``:
            Labels for computing the sequence classification/regression loss.
            Indices should be in ``[0, ..., config.num_labels - 1]``.
    ...
    """
    def __init__(self, config):
        super(my_ModelA2, self).__init__(config)
        self.num_labels = config.num_labels
...
class my_ModelB1(BertPreTrainedModel):
    r"""
        **labels**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size,)``:
            Labels for computing the sequence classification/regression loss.
            Indices should be in ``[0, ..., config.num_labels - 1]``.
    ...
    """
    def __init__(self, config):
        super(my_ModelB1, self).__init__(config)
        self.num_labels = config.num_labels
